        ...
        <div className='h-screen w-full bg-gradient-to-b from-black to-gray-800  fixed '>
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row ' >
                <div className=' flex-col justify-center'>
                    <h2 className='transition-opacity text-4xl sm:text-7xl font-bold color2 pt-6 md:pt-10 sm:pt-36 '>Front End Developer</h2>
                ...
                <div className='flex flex-col justify-center h-ful group'>
                    <img className=' w-3/5 md:w-2/3 z-10 mx-auto md:ml-48 md:pt-20 sm:w-2/5 duration-700 vibration' src={HeroImage} alt="Immagine Profilo" />
